          ...
          <div className="space-y-8 text-slate-100 text-sm md:text-base leading-relaxed">
            <div>
              ...
              <ul className="mt-3 space-y-2 list-disc list-inside">
                ...
                <li>
                  Successfully executed multiple campus events, ensuring timely
                  logistics and team alignment.
                </li>
                <li>
                  Fostered collaboration, responsibility, and team spirit among
                  peers through active engagement.
                </li>
              </ul>
            </div>
